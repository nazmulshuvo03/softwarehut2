...
<section id="main-content">
    <section class="wrapper">
        ...
        <section aria-hidden="false" style="display: block;" class="body current" aria-labelledby="wizard-h-0"
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="edit_dashboard.php">
                <b style="font-size:20px;color:#00004C">Company Information</b><br/> <br/><br/>
                <div class="form-group">
                    <label class="col-lg-2 control-label" style="color:#314A4A"><b>Company Name</b></label>
                    <div class="col-lg-8">
                        <input class="form-control" style="color:black" value="<?php echo $row['company_name'] ?> "
                               name="company_name" type="text">
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-lg-2 control-label" style="color:#314A4A"><b>Company Motto</b></label>
                    <div class="col-lg-8">
                        <input class="form-control" style="color:black" value="<?php echo $row['company_title'] ?>"
                               name="company_title" type="text">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input class="form-control" style="color:black" value="<?php echo $row['company_address'] ?>"
                               name="company_address" type="text">
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-lg-2 control-label" style="color:#314A4A"><b>Email</b></label>
                    <div class="col-lg-8">
                        <input class="form-control" style="color:black" value="<?php echo $row['company_email'] ?>"
                               name="company_email" type="text">
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-lg-2 control-label" style="color:#314A4A"><b>Mobile No.</b></label>
                    <div class="col-lg-8">
                        <input class="form-control" style="color:black" value="<?php echo $row['company_mobile'] ?>"
                               name="company_mobile" type="text">
                    </div>
                </div>
                <br/>
