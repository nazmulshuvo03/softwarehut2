...
<section id="main-content">
    <section class="wrapper">
        ...
        <section aria-hidden="false" style="display: block;" class="body current" aria-labelledby="wizard-h-0"
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="change_password_sql.php">


                <b style="font-size:20px;color:#00004C">Personal Information</b><br/> <br/><br/>
                <div class="form-group">
                    <label class="col-lg-2 control-label" style="color:#314A4A"><b>Current Password</b></label>
                    <div class="col-lg-8">
                        <input class="form-control" placeholder="Current Pssword" name="current_password"
                               type="password" required>
                    </div>
                </div>
                <br/><br/>
                <div class="form-group">
                    <label class="col-lg-2 control-label" style="color:#314A4A"><b>New Password</b></label>
                    <div class="col-lg-8">
