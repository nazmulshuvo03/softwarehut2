            ...
            <section class="wrapper">
                ...
                <section class="panel">
                    ...
                    if (isset($_GET['action'])) {
                        if ($_GET['action'] == "leave_edited") {
                            echo '<div class="alert">
				<div class="alert-success">Leave Information has been Edited Succesfully</div>
			</div>';
                        }
                    ...
                    <div id="editable-sample_wrapper" class="dataTables_wrapper form-inline" role="grid">
                        ...
                        <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample"
                            ...
                            <tr role="row">
                                ...
                                <th style="text-align:center;" class="sorting_disabled" role="columnheader" rowspan="1"
                                    colspan="1" aria-label="First Name" style="width: 188px;">Leave Taken
                                </th>
                                <th style="text-align:center;" class="sorting_disabled" role="columnheader" rowspan="1"
                                    colspan="1" aria-label="First Name" style="width: 188px;">Available Leave
                                </th>
                                <th style="text-align:center;" class="sorting_disabled" role="columnheader" rowspan="1"
                            ...
                            while ($row = mysql_fetch_array($result)) {
                                ...
                                <td>
                                    <table>
                                        <tbody style="color:black; text-align:center">
                                        <tr>
                                            <td><p><?php echo $row1['annual_leave'] - $row['annual_leave_taken'] ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><p><?php echo $row1['casual_leave'] - $row['casual_leave_taken'] ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td><p><?php echo $row1['others_leave'] - $row['others_leave_taken'] ?></p>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                ...
                                <td>
                                    <a class="edit" href="edit_leave.php?id=<?php echo $row['person_id']; ?>">Edit</a>
                                </td>
                                </tr>
