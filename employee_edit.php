...
<?php
$conn = connect_db();
$sql = "SELECT * FROM personal_information,employee_information,education_information,bank_information,employment_history
...
<section id="main-content">
    <section class="wrapper">
        ...
        <section aria-hidden="false" style="display: block;" class="body current" aria-labelledby="wizard-h-0"
            ...
            <form class="form-horizontal" method="post" action="employee_update.php" enctype="multipart/form-data">
				...
				<input type="file" name="employee_image" class="default"/>
			    </span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select class="form-control m-bot15" style="color:black" placeholder="Select One"
                                value="<?php echo $row['maritial_status']; ?>" name="maritial_status">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input class="form-control" style="color:black" placeholder="Bank Account Number"
                               value="<?php echo $row['account_number']; ?>" type="text" name="account_number">
                    </div>
                </div>
                <br><br>
