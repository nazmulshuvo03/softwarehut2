        ...
        <section class="wrapper">
            ...
            <section class="panel">
                ...
                if (isset($_GET['action'])) {
                    if ($_GET['action'] == "amount_of_leave_updated") {
                        echo '<div class="alert">
				<div class="alert-success">Amount of Leave Days has been Updated</div>
			</div>';
                    }
                ...
                <div id="editable-sample_wrapper" class="dataTables_wrapper form-inline" role="grid">
                    ...
                    <b style="font-size:20px;color:#00004C;padding-left:2%">Amount of leave In a year</b><br/> <br/><br>
                    <div style="padding-left:2%;padding-right:4%">
                        ...
                        <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample"
                            ...
                            <tr role="row">
                                <th style="text-align:center;" class="sorting_disabled" role="columnheader" rowspan="1"
                                    colspan="1" aria-label="First Name" style="width: 188px;">Leave Type
                                </th>
                                <th style="text-align:center;" class="sorting_disabled" role="columnheader" rowspan="1"
                                    colspan="1" aria-label="First Name" style="width: 188px;">Amount
                                </th>
                            </thead>
                            ...
                            <tr>
                                <td>
                                    <b style="color:#314A4A">Annual Leave</b>
                                </td>

                                <td>
                                    <?php echo $row['annual_leave'] ?> Days
                                </td>
                            </tr>
                            <tr style="background-color:#ECECEC;color:black">
                                <td>
                                    <b style="color:#314A4A"> Casual Leave</b>
                                </td>

                                <td>
                                    <?php echo $row['casual_leave'] ?> Days
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <b style="color:#314A4A">Medical Leave</b>
                                </td>

                                <td>
                                    <?php echo $row['medical_leave'] ?> Days
                                </td>
                            </tr>
                            <tr style="background-color:#ECECEC;color:black">
                                <td>
                                    <b style="color:#314A4A"> Others Leave</b>
                                </td>

                                <td>
                                    <?php echo $row['others_leave'] ?> Days
                                </td>
                            </tr>
                        ...
                        <form action="Amount_of_leave.php" style="display: inline; margin: 0; padding: 0;">
