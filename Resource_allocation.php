                    ...
                    <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample"
                        ...
                        <tr role="row">
                            ...
                            <th style="text-align:center;" class="sorting" role="columnheader" tabindex="0"
                                ...
                                aria-label="Last Name: activate to sort column ascending" style="width: 184px;">Employee
                                ID
                            </th>
                            <th style="text-align:center;" class="sorting_disabled" role="columnheader" rowspan="1"
                                colspan="1" aria-label="First Name" style="width: 188px;">Allocated Resource
                            </th>
                            <th style="text-align:center;" class="sorting_disabled" role="columnheader" rowspan="1"
                        ...
                        while ($row = mysql_fetch_array($result)) {
                            ...
                            ?>
                            <td class=" sorting_1"><?php echo $row['full_name']; ?></a></td>
...
<div style="width: 3px; z-index: auto; background: none repeat scroll 0% 0% rgb(64, 64, 64); cursor: default; position: fixed; top: 0px; left: 237px; height: 353px; display: block; opacity: 0;"
