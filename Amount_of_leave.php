...
<section id="main-content">
    <section class="wrapper">
        ...
        <section aria-hidden="false" style="display: block;" class="body current" aria-labelledby="wizard-h-0"
            ...
            $result1 = mysql_query($sql1, $conn) or die($sql . "<br/><br/>" . mysql_error());
            $row1 = mysql_fetch_array($result1);
            ?>


            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="edit_amount_of_leave.php">

                <b style="font-size:20px;color:#00004C">Amount of leave</b><br/> <br/><br/>
                <div class="form-group">
                    <label class="col-lg-2 control-label" style="color:#314A4A"><b>Annual</b></label>
                    <div class="col-lg-8">
                        <input class="form-control" style="color:black" value="<?php echo $row1['annual_leave']; ?>"
                               name="annual_leave" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label" style="color:#314A4A"><b>Casual</b></label>
                    <div class="col-lg-8">
                        <input class="form-control" style="color:black" value="<?php echo $row1['casual_leave']; ?>"
                               name="casual_leave" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label" style="color:#314A4A"><b>Medical</b></label>
                    <div class="col-lg-8">
                        <input class="form-control" style="color:black" value="<?php echo $row1['medical_leave']; ?>"
                               name="medical_leave" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label" style="color:#314A4A"><b>Others</b></label>
                    <div class="col-lg-8">
                        <input class="form-control" style="color:black" value="<?php echo $row1['others_leave']; ?>"
                               name="others_leave" type="text">
                    </div>
                </div>
                <br/>
