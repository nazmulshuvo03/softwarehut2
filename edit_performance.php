            ...
            <section class="wrapper">
                ...
                <section class="panel">
                    <div id="editable-sample_wrapper" class="dataTables_wrapper form-inline" role="grid">
                        ...
                        <form action="edit_performance_sql.php" method="post" id="task"
                            ...
                            <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample"
                                ...
                                <tr role="row">
                                    ...
                                    <th style="text-align:center;" class="sorting_disabled" role="columnheader"
                                        rowspan="1" colspan="1" aria-label="First Name" style="width: 188px;">NO. of
                                        Allocated Task
                                    </th>
                                    <th style="text-align:center;" class="sorting_disabled" role="columnheader"
                                        rowspan="1" colspan="1" aria-label="First Name" style="width: 188px;">No. of
                                    ...
                                    <th style="text-align:center;" class="sorting_disabled" role="columnheader"
                                        rowspan="1" colspan="1" aria-label="First Name" style="width: 188px;">Comment
                                    </th>
                                </thead>
                                ...
                                <tr class="odd">
                                    ...
                                    <td>
                                        <input class="form-control" style="color:black" name="allocated_task"
                                               type="text">
                                    </td>
                                    <td>
                                        <input class="form-control" style="color:black" name="completed_task"
                                               type="text">
                                    </td>
                                    <td>
                                        <input class="form-control" style="color:black" name="comment" type="text">
                                    </td>
                            ...
                            <button type="submit" class="btn btn-success" style="float: right">Save Me</button>
                        </form>
                        <script>
                            function validatetask() {
                                al = parseInt(document.forms['task']['allocated_task'].value);

                                cl = parseInt(document.forms['task']['completed_task'].value);

                                if (cl > al) {
                                    alert("Completed Task is Greater than Allocated Task");
                                    return false;
                                }
                                return true;
                            }
