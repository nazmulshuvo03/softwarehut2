...
<body data-savefrom-link-count="48">
            ...
            <section class="panel">
                <div id="editable-sample_wrapper" class="dataTables_wrapper form-inline" role="grid">
                    ...
                    <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample"
                        ...
                        <thead style="background-color:#00001F; color:white;font-size:15px">
                        <tr role="row">
                            ...
                            <th style="text-align:center;" class="sorting" role="columnheader" tabindex="0"
                                ...
                                aria-label="Last Name: activate to sort column ascending" style="width: 184px;">Bank
                                Name
                            </th>
                            <th style="text-align:center;" class="sorting" role="columnheader" tabindex="0"
                                aria-controls="editable-sample" rowspan="1" colspan="1"
                                aria-label="Points: activate to sort column ascending" style="width: 118px;">Branch Code
                            </th>
                            <th style="text-align:center;" class="sorting_disabled" role="columnheader" rowspan="1"
                                colspan="1" aria-label="First Name" style="width: 188px;">TIN No.
                            </th>
                            <th style="text-align:center;" class="sorting_disabled" role="columnheader" rowspan="1"
                                colspan="1" aria-label="First Name" style="width: 188px;">Bank Account Number
                            </th>
                            <th style="text-align:center;" class="sorting_disabled" role="columnheader" rowspan="1"
                        ...
                        <tbody role="alert" aria-live="polite" aria-relevant="all"
                               style="font-size:15px; color:black; text-align:center">
                        <?php
                        $conn = connect_db();
                        $sql = "SELECT * FROM personal_information,bank_information where personal_information.person_id=bank_information.person_id ";
                        ...
                        while ($row = mysql_fetch_array($result)) {
                            ...
                            <td class="center "><?php echo $row['tin_number']; ?></td>
...
<div style="width: 3px; z-index: auto; background: none repeat scroll 0% 0% rgb(64, 64, 64); cursor: default; position: relative; top: 0px; left: 237px; height: 353px; display: block; opacity: 0;"
     class="nicescroll-rails" id="ascrail2000">
    <div style="position: relative; top: 0px; float: right; width: 3px; height: 0px; background-color: rgb(31, 181, 173); background-clip: padding-box; border-radius: 10px;"></div>
</div>
<div style="height: 3px; z-index: auto; background: none repeat scroll 0% 0% rgb(64, 64, 64); top: 350px; left: 0px; position: fixed; cursor: default; display: none; opacity: 0; width: 237px;"
     class="nicescroll-rails" id="ascrail2000-hr">
    <div style="position: relative; top: 0px; height: 3px; width: 0px; background-color: rgb(31, 181, 173); background-clip: padding-box; border-radius: 10px; left: 0px;"></div>
</div>
<div style="width: 3px; z-index: 1000; background: none repeat scroll 0% 0% rgb(64, 64, 64); cursor: default; position: fixed; top: 0px; left: 1580px; height: 353px; opacity: 0;"
     class="nicescroll-rails" id="ascrail2001">
    <div style="position: relative; top: 0px; float: right; width: 3px; height: 246px; background-color: rgb(31, 181, 173); background-clip: padding-box; border-radius: 10px;"></div>
</div>
<div style="height: 3px; z-index: 1000; background: none repeat scroll 0% 0% rgb(64, 64, 64); top: 350px; left: 1343px; position: fixed; cursor: default; display: none; width: 237px; opacity: 0;"
